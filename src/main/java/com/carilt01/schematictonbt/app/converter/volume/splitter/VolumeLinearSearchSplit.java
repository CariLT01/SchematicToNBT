...
import com.carilt01.schematictonbt.app.converter.helpers.SlowTaskWatcher;
...
public class VolumeLinearSearchSplit implements VolumeSplittingMethod {

    private static final Logger logger = LoggerFactory.getLogger(VolumeLinearSearchSplit.class);

    public List<VolumeCoords> split(Volume volume, VolumeMeasurementSerializer vms, ProgressCallback progressCallback, int maxVolumeSize, float quality) throws IOException {
