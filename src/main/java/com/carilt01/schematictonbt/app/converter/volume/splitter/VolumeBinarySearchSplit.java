...
public class VolumeBinarySearchSplit implements VolumeSplittingMethod {

    private static final Logger logger = LoggerFactory.getLogger(VolumeBinarySearchSplit.class);
